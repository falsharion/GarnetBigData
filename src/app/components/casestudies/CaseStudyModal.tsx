...
// Background blobs configuration
const backgroundBlobs: BackgroundBlob[] = [
  {
    className:
      "absolute w-103 h-52 bg-gradient-to-r from-red-300/30 to-orange-200/30 rounded-full blur-2xl",
    style: { top: "8%", left: "-10%" },
  ...
  {
    className:
      "absolute w-103 h-52 bg-gradient-to-r from-blue-400/20 to-blue-200/25 rounded-full blur-3xl",
    style: { top: "8%", right: "-5%" },
    ...
    <AnimatePresence>
      {selectedStudy && (
        ...
        >
          ...
          >
            <div className="relative z-10 bg-white p-10 max-w-3xl w-full overflow-hidden">
              {/* Background blobs positioned relative to modal */}
              <div className="absolute inset-0 pointer-events-none">
                {backgroundBlobs.slice(0, 3).map((blob, i) => (
                  <motion.div
                    key={i}
              ...
              <div className="mt-6 space-y-6">
                <section>
                  ...
                  <p className="mt-2 text-gray-700">{selectedStudy.overview}</p>
                </section>
                ...
                <section>
                  ...
                  <p className="mt-2 text-gray-700">{selectedStudy.approach}</p>
                </section>
